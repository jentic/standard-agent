...
from agents.prebuilt_bedrock import ReACTAgent
...
def main() -> None:
    ...
    agent = ReACTAgent(model=os.getenv("LLM_MODEL", "us.anthropic.claude-3-5-haiku-20241022-v1:0"))
    logger.info("🤖 ReACT Agent (Bedrock) started. Enter goals to get started…")
